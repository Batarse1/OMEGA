...
DROP TABLE ODS.BUSINESS_ENTITY;
DROP TABLE ODS.ADDRESS;
DROP TABLE ODS.COUNTRY_REGION;
DROP TABLE ODS.BUSINESS_ENTITY_ADDRESS;
DROP TABLE ODS.EMAIL_ADDRESS;
DROP TABLE ODS.DEPARTMENT;
DROP TABLE ODS.EMPLOYEE;
DROP TABLE ODS.EMPLOYEE_DEPARTMENT_HISTORY;
DROP TABLE ODS.PRODUCT_CATEGORY;
DROP TABLE ODS.PRODUCT_SUBCATEGORY;
DROP TABLE ODS.STATE_PROVINCE;
DROP TABLE ODS.EMPLOYEE_PAY_HISTORY;
DROP TABLE ODS.PERSON;
DROP TABLE ODS.PERSON_PHONE;
DROP TABLE ODS.PRODUCT;
DROP TABLE DATA_WAREHOUSE.CUSTOMERS;
DROP TABLE DATA_WAREHOUSE.PRODUCTS;
DROP TABLE DATA_WAREHOUSE.EMPLOYEES;
